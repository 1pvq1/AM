...
/**
 * Calculates category details for a root node and its children.
 * This performs a "flatten" operation on the tree. In a mature file manager, 
 * this is replaced by SQL queries or List filtering on the database records.
 */
...
/**
 * Maps category definitions and file metadata to the UI model.
 */
